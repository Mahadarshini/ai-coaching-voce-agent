...
import { CoachingExpert, CoachingOption } from '@/services/Options'
                ...
                <DialogHeader>
                    ...
                    <DialogDescription asChild>
                        <div className='mt-3'>
                           ...
                           <div className='grid grid-cols-3 md:grid-col-5 gap-6 mt-3'>
                                {CoachingExpert.map((expert,index) => (
                                    ...
                                    >
                                        <Image src={expert.avatar} alt={expert.name}
                                            ...
                                            `}
                                        />
                                        <h2 className='text-left'>{expert.name}</h2>
                                    </div>
                                ))}
                           </div>
